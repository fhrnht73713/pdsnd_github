...
def station_stats(df):
    ...
    combo_station = df.groupby(['Start Station', 'End Station']).size().idxmax() # Group start and end station combinations together, calculate the size of each group, return the index of the combination with the maximum count.
...
def trip_duration_stats(df):
    ...
    # Display breakdown of total travel time (Create unified function for repeated use of seconds breakdown)
